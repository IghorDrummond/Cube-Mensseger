...
?>
									...
									<?php			
											...
											for($nCont = 0; $nCont <= count($Amigo) -1; $nCont++){
									?>
										<li class="list-group-item bg-info text-center w-100 d-flex justify-content-between align-items-center" id="<?php echo ($Amigo[$nCont][1]); ?>">
											<img src="<?php echo ($Amigo[$nCont][2]); ?>" class="border border-dark" align="left">
											<h6 class="d-inline"><?php echo (ucfirst(strtolower($Amigo[$nCont][1]))); ?></h6>
