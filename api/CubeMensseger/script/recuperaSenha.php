<?php
	...
	require_once('../../CubeMensseger/script/Exception.php');
	require_once('../../CubeMensseger/script/SMTP.php');
	require_once('../../CubeMensseger/script/PHPMailer.php');
	...
	$nCont = 0;
	//Constantes
	define('BD_USUARIO', '../../CubeMensseger/BDs/bd_usuarios.txt');	
...
//===============================Função==========================
	...
	function EnviaEmail($Email, $Nome, $Codigo){
		...
		try {
			...
			$mail->isSMTP();                                            
			$mail->SMTPAuth   = true;                                   
			$mail->Username   = 'deskdirectcontato@gmail.com';                     
			$mail->Password   = 'fpgqlajkjdmseqjh';                               
			$mail->SMTPSecure = 'tls';            
			...
			$mail->setFrom('deskdirectcontato@gmail.com', 'Não Responda - Código');
